...
public static class Screens
{
    ...
    public static Screen EnterDateTime(string text) =>
        new Screen()
        {
            Text = text,
    ...
    public static Screen SelectCustomDay(DateOnly today) =>
        new Screen()
        {
            Text = $"Enter the day. Example: {today.ToString(DateFormat.DayOnlyNumbers)}",
            Mode = ScreenMode.Replace
        };
    ...
    public static Screen SelectCategory(IEnumerable<Category> categories, bool includeShowAll) =>
        new Screen()
        {
            Text = "Enter the category",
            Options = categories
                .Select(c => new Option(c.Code, c.ShortName ?? c.Name))
                .Concat(includeShowAll ? [new Option(ShowAll)] : [])
                .ToList(),
            Mode = ScreenMode.Update
        };
    ...
    public static Screen SelectCurrency(IEnumerable<Currency> currencies, bool includeShowAll) =>
        new Screen()
        {
            Text = "Enter the currency",
            Options = currencies.Select(c => new Option(c.Name))
                .Concat(includeShowAll ? [new Option(ShowAll)] : [])
                .ToList(),
            Mode = ScreenMode.Update,
        };
    ...
    public static Screen NotifyWithStyle(string text) =>
        new Screen()
        {
            Text = text,
            UseMarkdown = true,
    ...
    public static Screen SelectStatistic() => new Screen()
    {
        ...
        Options = [
            ...
            new Option ("/dayByDay", "Day by day"),
    ...
    public static Screen SelectRequisiteSource() => new Screen()
    {
        Text = "Select the requisite source",
        Options = [
            new Option ("/yerevancity", "Yerevan city"),
            new Option ("/russianshop", "Russia"),
        ],
    };

    public static Screen NotifyOperationInProgress(string text) =>
        new Screen()
        {
            Text = text,
            Mode = ScreenMode.Update,
    ...
    public static Screen Canceled() => new Screen()
        {
            Text = "Canceled",
            Mode = ScreenMode.Ignore,
        };

    public static Screen EnterAskOrderId() => new Screen()
    {
        Text = "Enter the order id. It starts from 2 letters followed 10 numbers",
        Mode = ScreenMode.Replace
    };
}