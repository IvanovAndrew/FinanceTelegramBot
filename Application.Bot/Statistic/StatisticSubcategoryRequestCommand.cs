...
public class StatisticSubcategoryRequestCommandHandler(IFinanceRepository financeRepository, IMediator mediator) : StatisticQueryHandlerBase<StatisticSubcategoryRequestCommand>(financeRepository, mediator)
{
