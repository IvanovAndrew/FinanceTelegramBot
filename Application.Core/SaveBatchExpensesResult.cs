...
public class SaveBatchExpensesResult
{
    ...
    public static SaveBatchExpensesResult Saved(IReadOnlyCollection<Outcome> expenses, string fileName) => new(eSaveExpense.Saved, expenses, 
