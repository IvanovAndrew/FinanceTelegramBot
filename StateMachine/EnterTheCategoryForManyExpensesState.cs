...
class EnterTheCategoryForManyExpensesState : IExpenseInfoState
{
    ...
    internal EnterTheCategoryForManyExpensesState(IExpenseInfoState previousState, List<IExpense> expenses, ILogger logger)
    {
        _expenses = expenses;
        _logger = logger;
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return stateFactory.CreateEnterTheCategoryForManyExpenses(_expensesFromJson, this);
        }
    }
}